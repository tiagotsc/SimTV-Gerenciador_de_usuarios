...
class Usuario extends CI_Controller
{
	...
	public function __construct(){
        ...
        $this->load->model('atendimento/usuario_model','usuario');
        $this->load->model('atendimento/local_model','local');
    ...
    public function usuarios(){
        ...
        $this->layout->region('corpo', 'atendimento/usuario/view_psq_usuario');
    ...
    public function ficha($cd = false){
        ...
        $this->layout->region('corpo', 'atendimento/usuario/view_frm_usuario', $dados);
    ...
    public function salvar(){
        ...
        if($status){
            ...
            redirect(base_url('atendimento/usuario/ficha/'.$this->input->post('cd_usuario'))); 
            ...
            redirect(base_url('atendimento/usuario/ficha'));
    ...
    public function pesquisar($nome = null, $status, $pagina = null){
        ...
        $config['base_url'] = base_url('atendimento/usuario/pesquisar/'.$dados['postNome'].'/'.$dados['postStatus']); 
        ...
        $this->layout->region('html_header', 'view_html_header');
      	$this->layout->region('menu', 'view_menu', $menu);
        $this->layout->region('corpo', 'atendimento/usuario/view_psq_usuario', $dados);
      	$this->layout->region('rodape', 'view_rodape');
      	$this->layout->region('html_footer', 'view_html_footer');
    ...
    public function apaga(){
        ...
        if($status){
            ...
            redirect(base_url('atendimento/usuario/usuarios'));      
