...
*/
class ferraNeg extends CI_Controller
{
    
	/**
	 * ferraNeg::__construct()
	 * 
	 * @return
	 */
    ...
    function index()
    {
        ...
        $this->layout->region('corpo', 'ferraNeg/view_selecionar');
    ...
    public function perfis(){
        ...
        $this->layout->region('html_header', 'view_html_header');
      	$this->layout->region('menu', 'view_menu', $menu);
        $this->layout->region('menu_lateral', 'view_menu_lateral');
        $this->layout->region('corpo', 'ferraNeg/perfil/view_psq_perfil');
      	$this->layout->region('rodape', 'view_rodape');
      	$this->layout->region('html_footer', 'view_html_footer');
    ...
    public function ficha($cd = false){
        ...
        if($cd){
            ...
            $dados = $this->usuario->dadosferraNeg($cd);
            ...
            $campos = $this->usuario->camposferraNeg();
        ...
        $dados['cidade'] = $this->dadosBanco->cidade();
    ...
    public function pesquisar($nome = null, $status, $pagina = null){
        ...
        $dados['usuarios'] = $this->usuario->psqferraNegs($dados['postNome'], $dados['postStatus'], $pagina, $mostra_por_pagina);   
        $dados['qtdferraNegs'] = $this->usuario->psqQtdferraNegs($dados['postNome'], $dados['postStatus']);                     
        
        $config['base_url'] = base_url('usuario/pesquisar/'.$dados['postNome'].'/'.$dados['postStatus']); 
		$config['total_rows'] = $dados['qtdferraNegs'][0]->total;
    ...
    public function apaga(){
        ...
        try{
            ...
            $status = $this->usuario->deleteferraNeg();  
