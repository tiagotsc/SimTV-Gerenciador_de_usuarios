            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php              
                        ...
                        echo form_open('ferraNeg/usuario/apaga',$data);
    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Ferramentas de neg&oacute;cios - Pesquisar usu&aacute;rio</li>
                </ol>
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('ferraNeg/usuario/pesquisar',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
                            
                            $botaoCadastrar = "<a href='".base_url('ferraNeg/usuario/ficha')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>";
                            
                    		echo form_fieldset("Ferramenta de neg&oacute;cios - Pesquisar usu&aacute;rio".$botaoCadastrar, $attributes);
                ...
                foreach($usuarios as $usu){
                    ...
                    $cell3 = array('data' => html_entity_decode($usu->nome_cidade));
                    $cell4 = array('data' => html_entity_decode($usu->nome_departamento));
                    $cell5 = array('data' => $usu->nome_perfil);
                    
                    $botaoEditar = '<a title="Editar" href="'.base_url('ferraNeg/usuario/ficha/'.$usu->cd_usuario).'" class="glyphicon glyphicon glyphicon-pencil"></a>';
