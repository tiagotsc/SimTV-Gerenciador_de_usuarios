            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php              
                        ...
                        echo form_open('ferraNeg/perfil/apagaPerfil',$data);
    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Ferramenta de neg&oacute;cios - Pesquisar perfil</li>
                </ol>
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('ferraNeg/perfil/pesquisarPerfil',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
                            
                            $botaoCadastrar = "<a href='".base_url('ferraNeg/perfil/fichaPerfil')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>";
                            
                    		echo form_fieldset("Ferramentas de neg&oacute;cios - Pesquisar perfil".$botaoCadastrar, $attributes);
                ...
                foreach($perfis as $per){
                    ...
                    $botaoEditar = '<a title="Editar" href="'.base_url('ferraNeg/perfil/fichaPerfil/'.$per->cd_perfil).'" class="glyphicon glyphicon glyphicon-pencil"></a>';
                    $botaoExcluir = '<a title="Apagar" href="#" onclick="apagarRegistro('.$per->cd_perfil.',\''.$per->nome_perfil.'\')" data-toggle="modal"  data-target="#apaga" class="glyphicon glyphicon glyphicon glyphicon-remove"></a>';
