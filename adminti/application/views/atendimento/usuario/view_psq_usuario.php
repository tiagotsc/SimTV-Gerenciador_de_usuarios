            ...
            <div class="modal-content">
                ...
                <div class="modal-body">               
                    <?php              
                        ...
                        echo form_open('atendimento/usuario/apaga',$data);
            ...
            <div class="col-lg-12">
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('atendimento/usuario/pesquisar',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
                            
                            $botaoCadastrar = "<a href='".base_url('atendimento/usuario/ficha')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>";
                            
                    		echo form_fieldset("Atendimento - Pesquisar usu&aacute;rio".$botaoCadastrar, $attributes);
                ...
                <?php 
                $this->table->set_heading('Login', 'Nome', 'Cidade', 'Departamento', 'Perfil', 'Status', 'A&ccedil;&atilde;o');
                ...
                foreach($usuarios as $usu){
                    ...
                    $cell5 = array('data' => $usu->nome_perfil);
                    
                    $botaoEditar = '<a title="Editar" href="'.base_url('atendimento/usuario/ficha/'.$usu->cd_usuario).'" class="icone glyphicon glyphicon glyphicon-pencil"></a>';
                    $botaoExcluir = '<a title="Apagar" href="#" onclick="apagarRegistro('.$usu->cd_usuario.',\''.$usu->nome_usuario.'\')" data-toggle="modal"  data-target="#apaga" class="icone glyphicon glyphicon glyphicon glyphicon-remove"></a>';
