            ...
            <div class="col-lg-12">
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('atendimento/perfil/salvarPerfil',$data);
                            $attributes = array('id' => 'address_info', 'class' => 'address_info');
             
                    		echo form_fieldset("Cadastrar perfil<a href='".base_url('atendimento/perfil/perfis')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisa</a>", $attributes);
