                    	...
                    	echo form_open('usuario/salvar',$data);
                    		...
                    		echo form_fieldset("Ficha usu&aacute;rio<a href='".base_url('usuario/usuarios')."' class='linkDireita'><span class='glyphicon glyphicon-arrow-left'></span>&nbspVoltar Pesquisar</a>", $attributes);
                                ...
                                echo '<div class="row">';
                            		...
                            		echo form_label('Acesso ao sistema<span class="obrigatorio">*</span>', 'acesso_usuario');
                            		echo form_dropdown('acesso_usuario', $options, $acesso_usuario, 'id="acesso_usuario" class="form-control"');
                                    echo '</div>';
                                    
                                    echo '<div class="col-md-3">';
                                    $options = array('' => '');	
                                    foreach($unidade as $un){
                                        $options[$un->cd_unidade] = $un->nome;
                                    }	
                            		...
                            		echo form_dropdown('status_usuario', $options, $status_usuario, 'id="status_usuario" class="form-control"');
                                    echo '</div>';
