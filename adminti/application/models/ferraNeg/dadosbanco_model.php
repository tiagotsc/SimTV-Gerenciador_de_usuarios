...
class DadosBanco_model extends CI_Model{
    ...
    */
	public function status(){
		return $this->db->get('sistema.status')->result();
	}
    ...
    */
	public function permissoes(){
		...
		return $this->db->get('sistema.permissao')->result();
	}
    ...
    */
	public function paiPermissao(){
        ...
        $this->db->where("status_permissao =  'A'");
		$paisPemissao = $this->db->get('sistema.permissao')->result_array(); # TRANSFORMA O RESULTADO EM ARRAY
    ...
    */
	public function parametro(){
		...
		return $this->db->get('sistema.parametro')->result();
